...
@section('content')
    <section class="outer-bg h-100">
        <div class="head">
            <div class="title">les cartes</div>
            <a class="head-button add" href="{{ Route('cards.create') }}">
            ...
            <table>
                ...
                @foreach ($data['rows'] as $index => $item)
                    <tr>
                        ...
                        <td>
                            <div class="actions">
                                <a href={{ route('cards.edit', ['id' => $item['id']]) }} class="edit-button"
                                ...
                                <a href={{ route('cards.changeStatus', ['id' => $item['id']]) }} class={{ $item['active'] ? 'disactivited-button' : 'active-button' }} title="désactiver
                                   l'agence">
                                @if ($item['active'])
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
