...
@section('content')
    <section class="outer-bg">
        <div class="head">
            ...
            <a class="button-add" href="{{ Route('cards.add.type.of.card') }}"><i class="fa-solid fa-plus"></i></a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions btn-2">
                                    ...
                                    <a href={{ route('cards.edit.status', ['id' => $item['id']]) }} class='{{ $item['active'] ? 'active' : 'disactive' }}'>
