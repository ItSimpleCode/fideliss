...
@section('title', 'Agences - Ajouter')

@section('stylesheet')
    <link rel="stylesheet" href="{{ asset('dist/css/pages/agencies/add.css') }}">
@endsection
    ...
    <section class="outer-bg">
        <div class="head">
            <div class="title">
                ...
                <span>ajouter une nouvelle agence</span>
            </div>
        </div>
        <form class="form body" action="{{ route('agencies.insert') }}" method="POST">
            @csrf
            <div class="part">
                <div class="field">
